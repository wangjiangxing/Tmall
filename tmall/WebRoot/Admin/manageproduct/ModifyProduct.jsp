...
<form action="ProductList3.action" name="submitId" id="submitId">
<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">商品ID</label>
		<div class="col-sm-10">
			<input type="text" class="form-control"  name="SelectID"
				   placeholder="请输入新商品的ID">
				   <input type="button" value="查询" onclick="checkid()">
		</div>
	</div>
	</form>
	<form action="ProductList4.action" name="submitName" id="submitName">
	<div class="form-group">
		<br><label for="firstname" class="col-sm-2 control-label">商品名</label>
		<div class="col-sm-10">
	...
	<caption aligin="center">商品表</caption>
	<thead>
		<tr>
		<br>
			<th>ID</th>
	...
	<s:iterator value="#request.ProductList" id="myproductlist" status="status">  
		<tr align="center">
			...
			<th><a href="ProductModify.action?SelectID=<s:property value="id"/>">修改</a></th>
		</tr>
		</s:iterator> 
	</tbody>
	</table>
